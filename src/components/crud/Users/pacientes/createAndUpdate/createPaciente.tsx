...
import { 
    ICreatePaceinteProps,
    ICreatePacienteState
...
export class CreatePaciente extends React.Component<ICreatePaceinteProps, ICreatePacienteState> {
    init_user = {
        _id: "",
        nombre: "",
        apellido: "",
    ...
    _onCentroChange = (event: React.FormEvent<HTMLDivElement>, item?: IDropdownOption | undefined) => {
        if (item !== undefined)
            this.setState({
    ...
    _onCreateMedico = (event: any) => {
        ...
        if (this._isAmptyForm(this.state.user))
            ...
            const user = {
                ...this.state.user,
                centro: this.state.selected_option.key
            }
            this.setState({
                user: user
            }, () => {
                this.props.onCreatePaciente(this.state.user);
            });
        }
    }
    ...
    render (): React.ReactElement {
        return (
            <div className="container">
                ...
                <div className="card">
                    <br/>
                    <div className="card-title center">Crear Paciente</div>
                    <div className="card-content center">
                        <form onSubmit={ this._onCreateMedico }>
                            ...
                            <div className="row">
                                <div className="col s12 m6 input-field">
                                    <input type="text" placeholder="dni" name="dni" onChange={this.handleChange} value={ this.state.user.dni || "" }/>
                                </div>
                            </div>
