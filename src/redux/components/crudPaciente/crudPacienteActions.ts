...
function receiveCreatePaciente(user: Usuario, message: string) {
  return {
...
function receiveUpdatePaciente(user: Usuario, message: string) {
  return {
...
export function createPaciente(paciente: Usuario) {
  return function (dispatch) {
